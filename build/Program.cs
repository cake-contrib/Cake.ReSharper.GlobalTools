...
public static class Program
{
    public static int Main(string[] args)
    {
        return new CakeHost()
            ...
            .InstallTool(new Uri("nuget:?package=dotnet-reportgenerator-globaltool&version=5.1.4"))
            .InstallTool(new Uri("nuget:?package=dotnet-sonarscanner&version=5.5.3"))
            .InstallTool(new Uri("nuget:?package=JetBrains.ReSharper.GlobalTools&version=2021.3.4"))
